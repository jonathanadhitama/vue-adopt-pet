  ...
  <div class="home">
    ...
    <b-form @submit.prevent="handleSubmit" v-if="showPetForm">
      ...
      <b-form-group id="input-group-4" label="Pet's Age:" label-for="input-4">
        <b-form-input id="input-4" v-model="formData.age" required placeholder="Enter age"></b-form-input>
      </b-form-group>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      const { species, ...pet } = this.formData;
      this.addPet({ species, pet });
